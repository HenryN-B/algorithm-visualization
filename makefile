run_app:
	...
	find pages_files -exec sed -i.bak 's|_dash-component-suites|algorithm-visualization\\/_dash-component-suites|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-layout|algorithm-visualization/_dash-layout.json|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-dependencies|algorithm-visualization/_dash-dependencies.json|g' {} \;
	find pages_files -exec sed -i.bak 's|_reload-hash|algorithm-visualization/_reload-hash|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-update-component|algorithm-visualization/_dash-update-component|g' {} \;
	find pages_files -exec sed -i.bak 's|assets|algorithm-visualization/assets|g' {} \;
